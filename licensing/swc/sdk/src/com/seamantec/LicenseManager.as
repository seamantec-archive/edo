...
//    private static const END_POINT_URI:String = "http://beta.seamantec.com"
...
//                removeLicense(lic)
    ...
    function writeOutLicenses():void {
        ...
        EncryptedLocalStore.setItem(STORE_NAME, d);
    }
    ...
    private function loadLicenses():void {
        ...
        var d:ByteArray = EncryptedLocalStore.getItem(STORE_NAME);
        if (d === null) {
            return;
        }
        d.position = 0;
