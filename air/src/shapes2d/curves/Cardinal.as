...
// forked from makc3d's Cardinal Splines Part 4
    ...
    public class Cardinal implements ICurve2D
    {
        ...
        static public function compute( vertices:Vector.<Point>, precision:Number = .001, tension:Number = 1, loop:Boolean = false, target:Vector.<Point> = null, start:Number = 0, end:Number = 1 ):Vector.<Point>
		{
