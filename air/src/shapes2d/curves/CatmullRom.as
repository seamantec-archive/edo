...
/**
    ...
    */ 
    public class CatmullRom implements ICurve2D
    {
        ...
        public function getPointAt( t:Number, p:Point = null ):Point
		{
			...
			return CatmullRom.getPointAt( t, p ); 
			
		}
		
		public function range( start:Number, end:Number, target:Vector.<Point> = null ):Vector.<Point> 
		{
			target = CatmullRom.compute( vertices, precision, loop, target, start, end );
			if ( loop ) target.pop();
			return target;
		}
